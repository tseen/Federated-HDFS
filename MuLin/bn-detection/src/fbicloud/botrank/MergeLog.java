...
import fbicloud.botrank.MergeLogKeyComparator.*;
...
{
	public static class NetflowLogMapper extends Mapper <LongWritable, Text, CompositeKey, Text>
	{
	...
	public static class PcapLogMapper extends Mapper <LongWritable, Text, CompositeKey, Text>
	{
	...
	public int run ( String[] args ) throws Exception
	{
		...
		MultipleInputs.addInputPath( job, new Path(args[0]), TextInputFormat.class, NetflowLogMapper.class) ;
		MultipleInputs.addInputPath( job, new Path(args[1]), TextInputFormat.class, PcapLogMapper.class) ;
	...
	public static class userDefineMapper extends GenericProxyMapperSeq<CompositeKey, Text,CompositeKey, Text> {
		public userDefineMapper() throws Exception { super( CompositeKey.class, Text.class); }
	}
	public static class userDefineReducer extends GenericProxyReducerSeq<CompositeKey, Text> {
