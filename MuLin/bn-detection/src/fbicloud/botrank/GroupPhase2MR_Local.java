...
public class GroupPhase2MR_Local extends Configured implements Tool
{
	...
	public int run ( String[] args ) throws Exception
	{
		...
		levelTwoCluster.setJarByClass( GroupPhase2MR_Local.class ) ;
		...
		getAverageFVOfLevelTwoCluster.setJarByClass(GroupPhase2MR_Local.class);
		...
		levelThreeCluster.setJarByClass( GroupPhase2MR_Local.class ) ;
		...
		getAverageFVOfLevelThreeCluster.setJarByClass(GroupPhase2MR_Local.class);
		...
		assignFVID.setJarByClass(GroupPhase2MR_Local.class);
		...
		return assignFVID.waitForCompletion(true) ? 0: 1;
	}

	public static void main ( String[] args ) throws Exception
	{
		// Let ToolRunner handle generic command-line options
		int res = ToolRunner.run ( new Configuration(), new GroupPhase2MR_Local(), args ) ;
