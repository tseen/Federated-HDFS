...
public class Job extends JobContextImpl implements JobContext {  
   ...
   */
	public boolean waitForCompletion(boolean verbose) throws IOException,
        ...
        //FedJob進入點，建構完會設定完Flag
		FedJob fedJob = new FedJob(this);

		if (state == JobState.DEFINE) {
		    //isFedJob:是不是Fed ; isFedHdfsJob: 是不是在分配HDFS(目前是一開始的input)
	...
	public void setKeyValueReduceClass(Class<?> keyClz, Class<?> valueClz,
	...
	public void setKeyValueMapClass(Class<?> keyClz, Class<?> valueClz,
