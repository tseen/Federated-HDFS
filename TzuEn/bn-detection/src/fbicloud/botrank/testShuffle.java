...
public class testShuffle {
	...
	public static class Reduce extends Reducer<Text, Text, Text, Text> {
		@Override
		public void reduce_iter(Text key, Iterable<Text> values, Context context, HdfsWriter<Text, Text> fedJobCloud)
				throws IOException, InterruptedException {
			...
			fedJobCloud.write(key, new Text(result));
